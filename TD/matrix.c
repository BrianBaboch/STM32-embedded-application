...
void matrix_init(){
	...
	GPIOA->OSPEEDR = (GPIOA->OSPEEDR | GPIO_OSPEEDR_OSPEED3);
	GPIOA->OSPEEDR = (GPIOA->OSPEEDR | GPIO_OSPEEDR_OSPEED4);
	GPIOA->OSPEEDR = (GPIOA->OSPEEDR | GPIO_OSPEEDR_OSPEED5);
	GPIOA->OSPEEDR = (GPIOA->OSPEEDR | GPIO_OSPEEDR_OSPEED6);
	GPIOA->OSPEEDR = (GPIOA->OSPEEDR | GPIO_OSPEEDR_OSPEED7);
	GPIOA->OSPEEDR = (GPIOA->OSPEEDR | GPIO_OSPEEDR_OSPEED15);
	//Puts PB0, PB1 and PB2 in very high speed mode
	GPIOB->OSPEEDR = (GPIOB->OSPEEDR | GPIO_OSPEEDR_OSPEED0);
	GPIOB->OSPEEDR = (GPIOB->OSPEEDR | GPIO_OSPEEDR_OSPEED1);
	GPIOB->OSPEEDR = (GPIOB->OSPEEDR | GPIO_OSPEEDR_OSPEED2);
	//Puts PC3, PC4 and PC5 in very high speed mode
	GPIOC->OSPEEDR = (GPIOC->OSPEEDR | GPIO_OSPEEDR_OSPEED3);
	GPIOC->OSPEEDR = (GPIOC->OSPEEDR | GPIO_OSPEEDR_OSPEED4);
	GPIOC->OSPEEDR = (GPIOC->OSPEEDR | GPIO_OSPEEDR_OSPEED5);
	//Set RST to 0
